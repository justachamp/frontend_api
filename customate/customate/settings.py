...
AWS_SNS_NOTIFICATIONS_GOCUSTOMATE_SENDER = environ["AWS_SNS_NOTIFICATIONS_GOCUSTOMATE_SENDER"]
AWS_SES_SUBJECT_NAME = environ["AWS_SES_SUBJECT_NAME"]
...
# SECURE_SSL_REDIRECT - is not needed, balancer is responsible for HTTP redirects
...
AWS_S3_UPLOAD_SCHEDULE_DOCUMENTS_PATH = environ.get("AWS_S3_UPLOAD_SCHEDULE_DOCUMENTS_PATH", "documents/schedules")
AWS_S3_UPLOAD_ESCROW_DOCUMENTS_PATH = environ.get("AWS_S3_UPLOAD_ESCROW_DOCUMENTS_PATH", "documents/escrows")
...
CELERY_BEAT_SCHEDULE = {
    ...
    'once_per_day_update_statuses_of_unaccepted_schedules': {
        ...
        'schedule': crontab(hour='00', minute="10")  # 00:10 UTC every day
    },
    'once_per_day_update_statuses_of_unaccepted_escrows': {
        'task': 'frontend_api.tasks.escrows.process_unaccepted_escrows',
        'schedule': crontab(hour='00', minute="20")  # 00:20 UTC every day
    },
    ...
    'once_per_day_update_statuses_of_unaccepted_operations': {
        ...
        'schedule': crontab(hour='00', minute="40")  # 00:40 UTC every day
    },
}
...
DOCUMENTS_MAX_LIMIT_PER_ESCROW = DOCUMENTS_MAX_LIMIT_PER_SCHEDULE
ESCROW_OPERATION_APPROVE_DEADLINE = 7  # in days
