...
class Migration(migrations.Migration):
    dependencies = [
        ('frontend_api', '0028_extend_schedule_with_recipient_user'),
    ]
    ...
    sql_one_time = """
             create view frontend_api_one_time_schedule as 
               select "t1"."start_date" as "scheduled_date", "t1".*, "t6"."payment_account_id" from frontend_api_schedule as "t1" 
                 {joins}  
    ...
    sql_deposits = """
             create view frontend_api_deposits_schedule as
               select "t1"."deposit_payment_date" as "scheduled_date", "t1".*, "t6"."payment_account_id"  from frontend_api_schedule as "t1" 
               {joins}
    ...
    operations = [
        ...
        migrations.RunSQL("ALTER TABLE public.frontend_api_schedulepayments "
                          "DROP CONSTRAINT IF EXISTS frontend_api_schedulepayments_payment_id_schedule_id"),
