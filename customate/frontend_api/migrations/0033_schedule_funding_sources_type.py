...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=enumfields.fields.EnumField(enum=core.fields.FundingSourceType, max_length=max_field_length, null=True),
        ),
        migrations.RunPython(fill_in_schedules_funding_source_type),
        migrations.AlterField(
            model_name='schedule',
            name='funding_source_type',
            field=enumfields.fields.EnumField(enum=core.fields.FundingSourceType, max_length=max_field_length, null=False),
