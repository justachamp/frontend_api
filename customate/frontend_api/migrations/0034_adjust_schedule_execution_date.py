# Generated by Django 2.2 on 2019-09-04 08:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('frontend_api', '0033_schedule_funding_sources_type'),
    ]

    sql_adjust_schedule_execution_date_function = """
        CREATE OR REPLACE FUNCTION adjust_execution_date(origin_execution_date date, funding_source_type text)
            RETURNS timestamp AS
        $BODY$
        BEGIN
            IF funding_source_type = 'DIRECT_DEBIT' OR funding_source_type = 'CREDIT_CARD' THEN
                origin_execution_date := origin_execution_date - integer '7';
            END IF;
         
            RETURN origin_execution_date::timestamp;
        END;
        $BODY$
    ...
    operations = [
        migrations.RunSQL(sql_adjust_schedule_execution_date_function),
