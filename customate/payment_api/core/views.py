...
from payment_api.core.settings import api_proxy_settings
from payment_api.core.adapters import StreamingHTTPAdapter
from payment_api.core.utils import StreamingMultipart, generate_boundary
...
class ProxyView(BaseProxyView):
    ...
    def get_request_data(self, request):
        ...
        elif 'application/vnd.api+json' in request.content_type:
            return json.dumps({
                "data": {
                    "type": "identity",
        ...
        try:
            if files:
                ...
                response = requests.request(request.method, url,
                        ...
                        verify=verify_ssl,
                        cookies=cookies)
        except (ConnectionError, SSLError) as ex:
